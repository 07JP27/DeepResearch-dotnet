...
public class DeepResearchStarter(ILogger<DeepResearchStarter> logger)
{
    ...
    {
        var body = await JsonSerializer.DeserializeAsync<DeepResearchRequestBody>(req.Body, JsonSerializerOptions.Web);
...
public record DeepResearchRequestBody(string Topic);